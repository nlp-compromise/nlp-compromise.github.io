...
const text = `Lasciatemi cantare, con la chitarra in mano. Lasciatemi cantare, sono un italiano.
...
const numText = ref(`quando avrò sessantaquattro anni`)
const more = computed(() => {
  let doc = itCompromise(numText.value)
  doc.numbers().toNumber()
  return doc.text()
})

const example = `import tal from 'it-compromise'
