...
var app = (function () {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div, "background-color", /*accent*/ ctx[0]);
    			add_location(div, file$7, 12, 6, 282);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			if (default_slot) default_slot.c();
    			add_location(div0, file$7, 9, 2, 192);
    			attr_dev(div1, "class", "body svelte-1nervpm");
    			set_style(div1, "border-left", "3px solid " + /*left*/ ctx[1]);
    			add_location(div1, file$7, 10, 2, 202);
    			attr_dev(div2, "class", "column svelte-1nervpm");
    			add_location(div2, file$7, 8, 0, 169);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(div, "background-color", /*accent*/ ctx[0]);
    			add_location(div, file$6, 11, 6, 277);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div1, file$6, 15, 2, 367);
    			attr_dev(div2, "class", "column svelte-6r4k1");
    			add_location(div2, file$6, 8, 0, 174);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$5 = "lib/TextArea.svelte";
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			pre = element("pre");
    			code = element("code");
    			code.textContent = `${/*str*/ ctx[0]}`;
    			attr_dev(code, "class", "language-javascript mine svelte-19q7r33");
    			add_location(code, file$1, 19, 5, 423);
    			add_location(pre, file$1, 19, 0, 418);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
...
function cool(){
  console.log('nice')
    	...
    	$$self.$capture_state = () => ({ hljs: core, javascript, onMount, str });
    ...
    var tmp = { methods: methods$m, model: model$3, compute: compute$8, hooks };
    ...
    const methods$k = Object.assign({}, util, compute$7, loops, freeze);
    ...
    */
    ...
    function create_default_slot_1(ctx) {
    	...
    	function codemirror_text_binding(value) {
    		/*codemirror_text_binding*/ ctx[2](value);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			div1 = element("div");
    			div1.textContent = "compromise-speech";
    			t3 = space();
    			div2 = element("div");
    			t4 = space();
    			div3 = element("div");
    			div3.textContent = "tokenize words into approximately spoken syllables";
    			t6 = space();
    			...
    			attr_dev(div0, "class", "label svelte-1eanvrk");
    			add_location(div0, file, 53, 6, 1129);
    			attr_dev(div1, "class", "plugin svelte-1eanvrk");
    			add_location(div1, file, 54, 6, 1175);
    			set_style(div2, "margin-top", "2rem");
    			add_location(div2, file, 55, 6, 1225);
    			attr_dev(div3, "class", "down tab");
    			add_location(div3, file, 56, 6, 1264);
    			attr_dev(div4, "class", "res svelte-1eanvrk");
    			add_location(div4, file, 59, 6, 1391);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if ((!current || dirty & /*more*/ 2) && t8_value !== (t8_value = /*more*/ ctx[1]() + "")) set_data_dev(t8, t8_value);
    		},
    		i: function intro(local) {
    			if (current) return;
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "class", "");
    			add_location(a0, file, 68, 4, 1501);
    			attr_dev(a1, "href", "https://github.com/spencermountain/compromise/");
    			attr_dev(a1, "class", "");
    			add_location(a1, file, 69, 4, 1586);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "col svelte-1eanvrk");
    			add_location(div, file, 50, 0, 1071);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*text*/ 1) {
    			$$invalidate(1, more = () => {
    				let doc = nlp$1(text).compute('syllables');
    				return doc.syllables();
    			});
    		}
    	};

    	return [text, more, codemirror_text_binding];
    }
