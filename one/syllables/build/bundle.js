...
var app = (function () {
    ...
    */
    ...
    var tmp = { methods: methods$n, model: model$4, compute: compute$b, hooks };
    ...
    */
    ...
    const postProcess$1 = function (regs, opts = {}) {
    ...
    const syntax = function (input, opts = {}) {
      ...
      tokens = postProcess$2(tokens, opts);
