...
var app = (function (nlp) {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "line svelte-4ky4u7");
    			set_style(div, "background-color", /*accent*/ ctx[0]);
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$5, 18, 0, 374);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    */
    ...
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(72:10) {#each o.terms as term, i}",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 78, 10, 1851);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 70, 8, 1487);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_default_slot_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			t0 = text("viz inspired by ");
    			a = element("a");
    			a.textContent = "Peritext";
    			t2 = text(" by Geoffrey Litt.");
    			attr_dev(a, "href", "https://www.inkandswitch.com/peritext/");
    			add_location(a, file, 88, 22, 2009);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 63, 4, 1219);
    			attr_dev(div1, "class", "down tab desc");
    			add_location(div1, file, 65, 4, 1322);
    			attr_dev(div2, "class", "res col svelte-1u7lvp5");
    			add_location(div2, file, 68, 4, 1431);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div0, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 60, 0, 1132);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const doit = function () {
    		console.log('=-=-=-= here -=-=-=-');
    		$$invalidate(1, res = nlp__default["default"](str).json());
    	};
