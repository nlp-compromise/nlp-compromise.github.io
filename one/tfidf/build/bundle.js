...
var app = (function () {
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ colors: colors$3, color, bottom, cmp });
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	let { accent = '' } = $$props;
    	let { left = 'none' } = $$props;
    	left = colors$3[left] || left;
    	accent = colors$3[accent] || accent;
    	...
    	$$self.$capture_state = () => ({ accent, left, colors: colors$3 });
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$3, 48, 2, 1120);
    			attr_dev(div, "class", "outside svelte-1qxuf");
    			add_location(div, file$3, 47, 0, 1096);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    */
    ...
    var tmp = { methods: methods$n, model: model$5, compute: compute$b, hooks };
    ...
    const methods$m = Object.assign({}, util, compute$a, loops);
    ...
    Object.assign(View.prototype, api$a);
    var View$1 = View;
    ...
    const extend$1 = function (plugin, world, View, nlp) {
    ...
    nlp.plugin = function (plugin) {
      extend$2(plugin, this._world, View$1, this);
      return this
    };
    ...
    var sort$3 = { unique, reverse, sort: sort$2 };
    ...
    const looksOk$1 = function (terms, ids) {
    ...
    const methods$f = Object.assign({}, caseFns, insert$1, replace, remove, whitespace$1, sort$3, fork, concat, freeze, repair);
    ...
    */
    ...
    const toJSON = function (view, opts) {
      ...
      opts = Object.assign({}, defaults$4, opts);
    ...
    const getColor = function (node) {
      if (colors$2.hasOwnProperty(node.id)) {
        return colors$2[node.id]
      }
      if (colors$2.hasOwnProperty(node.is)) {
        return colors$2[node.is]
      }
      let found = node._cache.parents.find(c => colors$2[c]);
      return colors$2[found]
    };
    ...
    const compute$7 = function (allTags) {
    ...
    var tokenize$5 = normalizePunctuation;

    const parseTerm = txt => {
      // cleanup any punctuation as whitespace
      let { str, pre, post } = tokenize$5(txt);
      const parsed = {
        text: str,
        pre: pre,
        post: post,
    ...
    const tokenize$4 = function (input, world) {
    ...
    var compute$4 = { typeahead: compute$3 };
    ...
    var model$1 = { one: { contractions: contractions$3 } };
    ...
    var interpolateGnBu = ramp(scheme);

    /* one/tfidf/App.svelte generated by Svelte v3.43.0 */
    const file = "one/tfidf/App.svelte";
    ...
    // (41:14) {#each obj.terms as o, i}
    function create_each_block_1(ctx) {
    	let div2;
    	let div0;
    	let t0_value = /*o*/ ctx[9].normal + "";
    	let t0;
    	let t1;
    	let div1;
    	let t2_value = /*o*/ ctx[9].tfidf + "";
    	let t2;
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			t2 = text$1(t2_value);
    			add_location(div0, file, 42, 18, 1378);
    			attr_dev(div1, "class", "smol svelte-4vyd2r");
    			add_location(div1, file, 45, 18, 1458);
    			attr_dev(div2, "class", "word svelte-4vyd2r");
    			set_style(div2, "background-color", interpolateGnBu(/*o*/ ctx[9].tfidf / /*max*/ ctx[2]));
    			add_location(div2, file, 41, 16, 1283);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*more*/ 2 && t0_value !== (t0_value = /*o*/ ctx[9].normal + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*more*/ 2 && t2_value !== (t2_value = /*o*/ ctx[9].tfidf + "")) set_data_dev(t2, t2_value);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(41:14) {#each obj.terms as o, i}",
    		ctx
    	});
    ...
    // (39:10) {#each more() as obj}
    function create_each_block(ctx) {
    	let div;
    	let t;
    	let each_value_1 = /*obj*/ ctx[6].terms;
    	...
    	const block = {
    		c: function create() {
    			...
    			t = space();
    			add_location(div, file, 39, 12, 1221);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*interpolateGnBu, more, max*/ 6) {
    				each_value_1 = /*obj*/ ctx[6].terms;
    				validate_each_argument(each_value_1);
    				let i;
    ...
    function create_default_slot_1(ctx) {
    	...
    	function codemirror_text_binding(value) {
    		/*codemirror_text_binding*/ ctx[4](value);
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			div1 = element("div");
    			b = element("b");
    			b.textContent = "compromise-stats";
    			t3 = text$1(" plugin");
    			t4 = space();
    			div2 = element("div");
    			div2.textContent = "tfidf";
    			t6 = space();
    			div3 = element("div");
    			div3.textContent = "find the least-common words in a document";
    			t8 = space();
    			div6 = element("div");
    			div5 = element("div");
    			...
    			attr_dev(b, "class", "");
    			add_location(b, file, 31, 29, 898);
    			attr_dev(div1, "class", "plugin blue");
    			add_location(div1, file, 31, 4, 873);
    			attr_dev(div2, "class", "plugin");
    			add_location(div2, file, 32, 4, 948);
    			attr_dev(div3, "class", "down tab desc");
    			add_location(div3, file, 33, 4, 984);
    			attr_dev(div4, "class", "res row svelte-4vyd2r");
    			add_location(div4, file, 37, 8, 1155);
    			set_style(div5, "flex-grow", "1");
    			add_location(div5, file, 35, 6, 1088);
    			attr_dev(div6, "class", "both");
    			add_location(div6, file, 34, 4, 1063);
    		},
    		m: function mount(target, anchor) {
    			...
    			mount_component(codemirror, div5, null);
    			append_dev(div5, t9);
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*more, interpolateGnBu, max*/ 6) {
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "href", "https://observablehq.com/@spencermountain/compromise-stats");
    			attr_dev(a0, "class", "");
    			add_location(a0, file, 58, 4, 1700);
    			attr_dev(a1, "href", "https://github.com/spencermountain/compromise/tree/master/plugins/stats");
    			attr_dev(a1, "class", "");
    			add_location(a1, file, 59, 4, 1791);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 27, 0, 744);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
...
`;
    	...
    	return [text, more, max, example, codemirror_text_binding];
    }
