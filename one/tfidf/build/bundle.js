...
var app = (function () {
    ...
    */
    ...
    const compile$1 = function (input) {
    ...
    */
    ...
    // (37:10) {#each more() as o}
    function create_each_block(ctx) {
    	let div2;
    	let div0;
    	let t0_value = /*o*/ ctx[5][0] + "";
    	let t0;
    	let t1;
    	let div1;
    	let t2_value = /*o*/ ctx[5][2] + "";
    	let t2;
    	let t3;
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = text$1(t2_value);
    			t3 = space();
    			add_location(div0, file, 38, 14, 1260);
    			attr_dev(div1, "class", "smol svelte-4vyd2r");
    			add_location(div1, file, 41, 14, 1324);
    			attr_dev(div2, "class", "word svelte-4vyd2r");
    			set_style(div2, "background-color", interpolateGnBu(/*o*/ ctx[5][2] * 10));
    			add_location(div2, file, 37, 12, 1173);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*more*/ 2 && t0_value !== (t0_value = /*o*/ ctx[5][0] + "")) set_data_dev(t0, t0_value);
    			if (dirty & /*more*/ 2 && t2_value !== (t2_value = /*o*/ ctx[5][2] + "")) set_data_dev(t2, t2_value);
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 28, 4, 785);
    			attr_dev(b, "class", "");
    			add_location(b, file, 29, 29, 852);
    			attr_dev(div1, "class", "plugin blue");
    			add_location(div1, file, 29, 4, 827);
    			attr_dev(div2, "class", "plugin");
    			add_location(div2, file, 30, 4, 902);
    			attr_dev(div3, "class", "down tab desc");
    			add_location(div3, file, 31, 4, 938);
    			attr_dev(div4, "class", "res row svelte-4vyd2r");
    			add_location(div4, file, 35, 8, 1109);
    			set_style(div5, "flex-grow", "1");
    			add_location(div5, file, 33, 6, 1042);
    			attr_dev(div6, "class", "both");
    			add_location(div6, file, 32, 4, 1017);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*interpolateGnBu, more*/ 2) {
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a0, "href", "https://observablehq.com/@spencermountain/compromise-typeahead");
    			attr_dev(a0, "class", "");
    			add_location(a0, file, 52, 4, 1518);
    			attr_dev(a1, "href", "https://github.com/spencermountain/compromise#one");
    			attr_dev(a1, "class", "");
    			add_location(a1, file, 53, 4, 1613);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 25, 0, 698);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
...
`;
    	...
    	return [text, more, example, codemirror_text_binding];
    }
