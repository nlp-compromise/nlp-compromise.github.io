...
var app = (function () {
    ...
    */
    ...
    var tmp = { methods: methods$n, model: model$4, compute: compute$a, hooks };
    ...
    */
    ...
    var model = { two: { contractions: contractions$3 } };
    ...
    /* one/typeahead/App.svelte generated by Svelte v3.43.0 */
    const file = "one/typeahead/App.svelte";
    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = space();
    			div1 = element("div");
    			div1.textContent = "type-ahead";
    			t3 = space();
    			div2 = element("div");
    			div2.textContent = "assume a word, before it is fully-typed";
    			t5 = space();
    			div5 = element("div");
    			div4 = element("div");
    			...
    			add_location(div0, file, 76, 6, 1427);
    			attr_dev(div1, "class", "plugin");
    			add_location(div1, file, 77, 6, 1471);
    			attr_dev(div2, "class", "down tab desc");
    			add_location(div2, file, 78, 6, 1514);
    			attr_dev(div3, "class", "res svelte-1td51vq");
    			add_location(div3, file, 82, 10, 1707);
    			set_style(div4, "flex-grow", "1");
    			add_location(div4, file, 80, 8, 1620);
    			attr_dev(div5, "class", "both svelte-1td51vq");
    			add_location(div5, file, 79, 6, 1593);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if ((!current || dirty & /*more*/ 2) && t7_value !== (t7_value = /*more*/ ctx[1]() + "")) set_data_dev(t7, t7_value);
    			const two_changes = {};
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "col svelte-1td51vq");
    			add_location(div, file, 73, 0, 1369);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
...
`;
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*text*/ 1) {
    			$$invalidate(1, more = () => {
    				let doc = nlp$1(text).compute('typeahead');
    				doc.autoFill();
    				return doc.text();
    			});
    		}
    	...
    	return [text, more, words, example, codemirror_text_binding];
    }
