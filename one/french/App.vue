...
const text = `Je m'baladais sur l'avenue le cœur ouvert à l'inconnu
...
const numText = ref(`quand j'aurai soixante quatre ans`)
const more = computed(() => {
  let doc = frCompromise(numText.value)
  doc.numbers().toNumber()
  return doc.text()
})

const example = `import tal from 'fr-compromise'
