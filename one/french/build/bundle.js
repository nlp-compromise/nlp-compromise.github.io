    ...
    function create_default_slot_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 42, 4, 1109);
    			attr_dev(div1, "class", "down tab desc");
    			add_location(div1, file, 43, 4, 1150);
    			attr_dev(div2, "class", "top");
    			add_location(div2, file, 46, 8, 1279);
    			attr_dev(div3, "class", "res svelte-da5iiy");
    			set_style(div3, "position", "relative");
    			add_location(div3, file, 49, 8, 1409);
    			set_style(div4, "flex-grow", "1");
    			add_location(div4, file, 45, 6, 1245);
    			attr_dev(div5, "class", "both");
    			add_location(div5, file, 44, 4, 1220);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 39, 0, 1022);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
