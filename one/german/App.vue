...
const text = `Du, könntest du schwimmen.
...
const numText = ref(`wenn ich vierundsechzig Jahre alt bin`)
const more = computed(() => {
  let doc = deCompromise(numText.value)
  doc.numbers().toNumber()
  return doc.text()
})

const example = `import pln from 'de-compromise'
