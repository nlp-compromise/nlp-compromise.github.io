...
var app = (function () {
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ onMount, bottom, cmp });
    	...
    	return [bottom, $$scope, slots];
    }

    class Page extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { bottom: 0 });
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$4, 6, 4, 92);
    			add_location(div1, file$4, 9, 4, 179);
    			attr_dev(div2, "class", "box svelte-10fnxb0");
    			add_location(div2, file$4, 5, 2, 70);
    			attr_dev(div3, "class", "column svelte-10fnxb0");
    			add_location(div3, file$4, 4, 0, 47);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class One extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { left: 0 });
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "style", "");
    			add_location(div0, file$3, 5, 4, 65);
    			add_location(div1, file$3, 8, 4, 123);
    			attr_dev(div2, "class", "box svelte-l0y2fi");
    			add_location(div2, file$3, 4, 2, 43);
    			attr_dev(div3, "class", "column svelte-l0y2fi");
    			add_location(div3, file$3, 3, 0, 20);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    var tmp = { methods: methods$n, model: model$5, compute: compute$7, hooks };
    ...
    var freeze = methods$m;

    const methods$l = Object.assign({}, util, compute$6, loops, freeze);
    ...
    Object.assign(View.prototype, api$8);
    var View$1 = View;
    ...
    const toTitleCase$2 = function (str) {
    ...
    const methods$g = Object.assign({}, caseFns, insert$1, replace, remove, whitespace$1, sort$1, fork);
    ...
    */
    ...
    const methods$9 = Object.assign({}, out, text);
    ...
    const setTag$1 = function (terms, tag, world = {}, isSafe) {
    ...
    let allTags = Object.assign({}, nouns, verbs$1, values, dates$1, misc$3);

    const tagSet = compute$4(allTags);
    var tagSet$1 = tagSet;
    ...
    let keys$1 = Object.keys(conjugations);
    ...
    var lexData = {
      ...
      "Expression": "true¦a05b04d00eYfuck,gVhNlKmJnHoEpCshBtsk,u8voi07w3y0;a1eOu0;ck,p;!a,hoo,y;h2o1t0;af,f;rd up,w;e0oa;e,w;gh,h0;! 0h,m;huh,oh;eesh,hh,it;ff,hew,l0sst;ease,z;h1o0w,y;h,o,ps;!h;ah,o0;!pe;eh,mm;m1ol0;!s;ao,fao;a5e3i,mm,oly2u0;h,rr0;ah;! mo6;e,ll0y;!o;ha0i;!ha;ah,ee,o0rr;l0odbye;ly;e0h,t cetera,ww;k,p;'oh,a0uh;m0ng;mit,n0;!it;ah,oo,ye; 1h0rgh;!em;la",
      ...
      "Organization": "true¦0:41;a36b2Oc28d20e1Wf1Sg1Kh1Fi1Cj19k17l12m0Sn0Go0Dp07qu06rZsStFuBv8w3y1;amaha,m0Xou1w0X;gov,tu2P;a3e1orld trade organizati3W;lls fargo,st1;fie21inghou16;l1rner br38;gree2Xl street journ23m11;an halNeriz3Risa,o1;dafo2El1;kswagLvo;bs,kip,n2ps,s1;a tod2Ops;es30i1;lev2Tted natio2Q; mobi2Haco bePd bMeAgi frida9h3im horto2Pmz,o1witt2S;shiba,y1;ota,s r Y;e 1in lizzy;b3carpen2Ydaily ma2Sguess w2holli0rolling st1Ls1w2;mashing pumpki2Kuprem0;ho;ea1lack eyed pe3Ayrds;ch bo1tl0;ys;l2s1;co,la m11;efoni07us;a6e4ieme2Cnp,o2pice gir5ta1ubaru;rbucks,to2I;ny,undgard1;en;a2Mx pisto1;ls;few22insbury2Imsu1U;.e.m.,adiohead,b6e3oyal 1yan2S;b1dutch she4;ank;aders dige1Cd 1max,vl2X;bu1c1Rhot chili peppe2Flobst24;ll;c,s;ant2Qizno2A;an5bs,e3fiz20hilip morrBi2r1;emier22udenti12;nk floyd,zza hut;psi23tro1uge07;br2Lchina,n2L; 2ason1Tda2B;ld navy,pec,range juli2xf1;am;us;a9b8e5fl,h4i3o1sa,wa;kia,tre dame,vart1;is;ke,ntendo,ss0J;l,s;c,st1Btflix,w1; 1sweek;kids on the block,york07;a,c;nd1Ps2t1;ional aca2Ao,we0O;a,cXd0M;a9cdonald8e5i3lb,o1tv,yspace;b1Insanto,ody blu0t1;ley crue,or0M;crosoft,t1;as,subisN;dica2rcedes benz,talli1;ca;id,re;'s,s;c's milk,tt10z1U;'ore08a3e1g,ittle caesa1G;novo,x1;is,mark; 1bour party;pres5z boy;atv,fc,kk,m1od1F;art;iffy lu0Ioy d1Ppmorgan1sa;! cha1;se;bm,hop,n1tv;g,te1;l,rpol;asbro,ewlett packaSi3o1sbc,yundai;me dep1n1F;ot;tac1zbollah;hi;eneral 6hq,l5mb,o2reen d0Gu1;cci,ns n ros0;ldman sachs,o1;dye1g09;ar;axo smith kliYencore;electr0Fm1;oto0R;a3bi,da,edex,i1leetwood mac,oFrito l08;at,nancial1restoU; tim0;cebook,nnie mae;b04sa,u3xxon1; m1m1;ob0D;!rosceptics;aiml07e5isney,o3u1;nkin donuts,po0Sran dur1;an;j,w j1;on0;a,f leppa2ll,peche mode,r spiegWstiny's chi1;ld;rd;aEbc,hBi9nn,o3r1;aigsli5eedence clearwater reviv1ossra02;al;ca c5l4m1o07st02;ca2p1;aq;st;dplLgate;ola;a,sco1tigroup;! systems;ev2i1;ck fil-a,na daily;r0Ey;dbury,pital o1rl's jr;ne;aEbc,eBf9l5mw,ni,o1p,rexiteeU;ei3mbardiIston 1;glo1pizza;be;ng;o2ue c1;roV;ckbuster video,omingda1;le; g1g1;oodriL;cht2e ge0rkshire hathaw1;ay;el;nana republ3s1xt5y5;f,kin robbi1;ns;ic;bWcRdidQerosmith,ig,lKmEnheuser-busDol,pple9r6s3v2y1;er;is,on;hland1sociated F; o1;il;by4g2m1;co;os; compu2bee1;'s;te1;rs;ch;c,d,erican3t1;!r1;ak; ex1;pre1;ss; 4catel2t1;air;!-luce1;nt;jazeera,qae1;da;as;/dc,a3er,t1;ivisi1;on;demy of scienc0;es;ba,c",
      ...
      "Honorific": "true¦aObrigadiNcGdFexcellency,fiAking,liCma9officNp5queen,r2s0taoiseach,vice4;e0ultJ;cond liArgeaB;abbi,e0;ar0verend; adK;astGr0;eside6i0ofessF;me ministFnce0;!ss;gistrate,r4yC;eld mar3rst l0;ady,i0;eutena0;nt;shB;oct6utchess;aptain,hance4o0;lonel,mmand5ngress1un0;ci2t;m0wom0;an;ll0;or;er;d0yatullah;mir0;al",
      "Pronoun": "true¦'em,elle,h4i3me,ourselves,she5th1us,we,you0;!rself;e0ou;m,y;!l,t;e0im;!'s",
      "Singular": "true¦0:1N;a1Lb16c0Wd0Oe0Kf0Fg08h01i00jZkey,lXmUnToSpLquestionKrIsCt6u3vaccuum,w1zG;ay1heel,om0C;! arou1A;nc0Js1; 1h1E;doll0Vst0Y; rex,ax return,e5h4i3r1v show;a1ip;ck,gedy;c,de,re;ere,i1A;am,e;ce1Aecurity gua11hack,i5kill,ome4t1uper bowl,yst1E;ep2ri17udent1;! loZ;faWmoW;one;st11te,ze;a1eNi12oom;ck,l0;! mark;a6encil,i5la4r2u1;ddi0YrpoH;e1ie0Mobl13;roga05ss releaF;te,y0T;er,g,pe;ir,n,te0V;bj00ceLthers,verview;e0Kothi0Rumb0P;ayf0eeti0Qo1;m1nopo0rni0Pth0NuZ;!my;at1un1;ch;el0uiJ;nsect,ron;a6ead5igh scho01o1uman right;le,me2r1;se;! 1;run;! start;m,ze;a6e4irl03laci0Aod,rand2u1;l0n,y; slam,fa1mo1;th07;ar,ek,ntlem1;an;df0ng;a4e2lame,ol0r1;ee market,ieWonti02;lla,n1;ce;mi0thZ;conomy,gg,ner6ven3x1;amp1ecu8;le;iXt;ad7e3innUo1ragonf0ude;cumentGg1i0or;gy;a3fault rCt1;ec1;tive;th;!dy;a8eiliOh5i3lieQo1redit caH;tSu1;riKsL;ty,vil w1;ar;andeliHocol2ristmas car1;ol;ate;n1pital,rriE;ary;aAe8o4r1utterf0;eakfa2o1;!thA;st;a3dy,g,y1;!frie1;nd;rd;a1l0;n,r;nki4r1;ga2ri1;er;in;ng;d3l0noma0u1;nt;ly; homin2van1;tage;em",
      "Uncountable": "true¦0:24;1:1O;2:1D;a1Yb1Oc1Gd1De16f0Yg0Sh0Ni0Ij0Hk0Gl0Am00nYoXpTrOsDt7vi6w3;arm8ea0Ei4oo3;d,l;ldlife,ne;neg1Eol0Htae;e7h6ime,oothpaste,r3una;affWou4ue nor3;th;ble,sers,t;ermod1Tund1;a,nnis;aBcene0Feri2hAil9kittl2now,o8p6t4u3;g16nshi0W;ati1Se3;am,el;ace1Le3;ci2ed;ap,cc1;k,v1;eep,ingl2;d0Ife1Fl3nd,ti0L;m18t;a6e4ic3;e,ke0R;c3laxa0Osearch;ogni0Nrea0N;bi2in;aTe5hys0lastBo3resN;l3rk,w1;it0yC;a19tr03;bstetr0xygen;a3ews;il poli08tional securi12;aAe8o5u3;mps,s3;ic;n3o0L;ey,o3;gamy;a3chan0;sl2t;chine3il,themat0; learn0Kry;aught1e5i4ogi0Xu3;ck,g0N;ce,ghtn0Hngui0VteraP;a4i3;suO;th1;elvin,nowled0J;azz,ewelBusti0O;ce,gnor6mp3nformaWtself;a3ort5;ti3;en0K;an0J;a6eFisto5o3;ck3mework,n3spitali0D;ey;ry;ir,libut,ppiD;ene5ol4r3um,ymna0F;aCound;d,f; 3t0;editXpo3;ol;icGl8o5urni3;tu3;re;od,rgive3uri1wl;ne3;ss;e3our;sh;conom0duca8lectr7n5quip6th0very3;body,o3thM;ne;joy3tertain3;ment;iciQon0;tiJ;iabet2raugh3;ts;es;a9elcius,h6iv0l5o3urrency;al,ld w3nfusiEttE;ar;ass0othA;aos,e3;e3w8;se;r9sh;a9eef,i6lood,owls,read,u3;nt4tt1;er;ing;lliar4s3;on;ds;g3ss;ga3;ge;c8dvi7ero5ir4mnes3rt,thlet0;ty;craft;b0d3naut0;ynam0;ce;id,ou3;st0;ics",
      "Comparable": "true¦0:3Q;1:46;2:3U;3:2Q;a4Ab3Rc3Ed33e2Vf2Ig26h1Vi1Oj1Nk1Kl1Cm16n10o0Yp0Pqu0Nr0FsPtJuFvDw5y4za0X;ell1You3P;a9e7hi1Qi5r4;o3Ny;ck3Yde,l4n1ry,se;d,y;a4i48t;k,ry;nti3Ir4;m,y;a4erda2ulgar;g7in,st;g0n4pcomi3E;like0t4;i1r4;ue;a8en7hi6i5ough,r4;anqu2Fen1ue;dy,g3Gme0ny,r3K;ck,n,rs2G;d3Nse;ll,me,rt,wd3S;aScarReQhOiNkin0BlJmHoFpEqua18t8u5w4;eet,ift;b5dd0Yper0Br4;e,re29;sta27t3;a8e7iff,r5u4;pUr1;a4ict,o2X;ig34n0P;a1ep,rn;le,rk;e1Ui34right0;ci20ft,l4on,re,ur;emn,id;a4el0ooth;ll,rt;e6i4ow,y;ck,g2Vm4;!y;ek,nd32;ck,l0mp3;a4iQort,rill,y;dy,ll0Rrp;cu0Lve0Lxy;ce,ed,y;d,fe,int0l1Ov0Y;a9e7i6o4ude;mantic,o1Bsy,u4;gh,nd;ch,pe,tzy;a4d,mo0C;dy,l;gg2Kndom,p4re,w;id;ai2i4;ck,et;a3hoBi1KlAo9r6u4;ny,r4;e,p3;egna2ic5o4;fouVud;ey,k0;li00or,te15;ain,easa2;ny;dd,f4i0ld,ranO;fi0V;a8e6i5o4;b3isy,rm10sy;ce,mb3;a4w;r,t;ive,rrX;a8e6ild,o5u4;nda14te;ist,o1;a4ek,llT;s0ty;d,tuM;a9e8i7o4ucky;f0Pn5o18u4ve0w12y0O;d,sy;e0g;g1Lke0tt3ve0;an,wd;me,r4te;ge;e5i4;nd;en;ol0ui1H;cy,ll,n4;s7t4;e4ima5;llege2rmedia4;te;ecu4ta2;re;aCe9i8o6u4;ge,m4ng1K;b3id;ll4me0t;ow;gh,l0;a4f01sita2;dy,v4;en0y;nd1Appy,r4;d,sh;aEenDhBiAl9oofy,r4;a7e6is0o4ue17;o4ss;vy;at,en,y;nd,y;ad,ib,ooF;a2d1;a4o4;st0;t3uiV;u1y;aFeeb3iAlat,o8r6u4;ll,n4r0X;!ny;aEe4iend0;e,sh;a4rmEul;my;erce6n4rm;an4e;ciA;! ;le;ir,ke,n0Ar,st,t,ul8;a8erie,mp7sse5v4xtre0K;il;nti4;al;ty;r5s4;tern,y;ly,th0;aDeAi7r5u4;ll,mb;u4y;nk;r5vi4;ne;e,ty;a4ep,nB;d4f,r;!ly;mp,ppXrk;aEhBl8o6r5u4;dd0r0te;isp,uel;ar4ld,mmon,ol,st0ward0zy;se;e4ou1;a4vQ;n,r;e4il0;ap,e4;sy;gey,lm,ri4;ng;aKiIlFoCr6u4;r0sy;ly;a8i5o4;ad,wn;ef,g5llia2;nt;ht;sh,ve;ld,r5un4;cy;ed;a5o4ue;nd,o1;ck,nd;g,tt4;er;d,ld,w1;dy;bsu7ng6we4;so4;me;ry;rd",
guc98mo6VsDzaA;aAhiA8;iao,u;aHeGiEoDright,u;jc8Tng;lDmm0nkl0sniewsA;liA2s2;b0iss,lt0;a5Tgn0lDtanabe;k0sh;aHeGiEoDukB;lk5roby5;dBllalDnogr30r10ss0val38;ba,obos;lasEsel7P;lGn dFrg8FsEzD;qu7;ily9Pqu7silj9P;en b36ijk,yk;enzue96verde;aLeix1KhHi3j6ka3JoGrFsui,uD;om50rD;c3n0un1;an,embl8UynisA;dor96lst32m4rr9th;at5Ni7NoD;mErD;are70laci65;ps2s0Z;hirBkah8Enaka;a01chXeUhQiNmKoItFuEvDzabo;en8Bobod35;ar7bot4lliv3zuA;aEein0oD;i68j3Myan8W;l6rm0;kol5lovy5re6Rsa,to,uD;ng,sa;iDy60;rn5tD;!h;l5ZmEnDrbu;at8gh;mo6Eo6K;aFeDimizu;hu,vchD;en7Duk;la,r17;gu8mDoh,pulve8Trra4S;jDyD;on5;evi6Giltz,miDneid0roed0ulz,warz;dEtD;!z;!t;ar42h6ito,lFnDr4saAto,v4;ch7d0AtDz;a4Pe,os;as,ihBm3Zo0Q;aOeNiKoGuEyD;a67oo,u;bio,iz,sD;so,u;bEc7Bdrigue57g03j73mDosevelt,ssi,ta7Nux,w3Z;a4Ce0O;ertsDins2;!on;bei0LcEes,vDzzo;as,e8;ci,hards2;ag3es,it0ut0y9;dFmEnDsmu7Zv5F;tan1;ir7os;ic,u;aSeLhJiGoErDut6;asad,if60ochazk1W;lishc24pDrti63u55we67;e2Tov48;cEe09nD;as,to;as61hl0;aDillips;k,m,n5L;de3AetIna,rGtD;ersErovDtersC;!a,ic;en,on;eDic,ry,ss2;i8ra,tz,z;ers;h71k,rk0tEvD;ic,l3T;el,t2O;bJconnor,g2ClGnei5QrEzD;demir,turk;ella3MtDwe5O;ega,iz;iDof6GsC;vDyn1F;ei8;aPri1;aLeJguy1iFoDune44ym3;rodahl,vDwak;ak3Uik5otn57;eEkolDlsCx2;ic,ov6X;ls1miD;!n1;ils2mD;co42ec;gy,kaEray3varD;ro;jiDmu8shiD;ma;aXcVeQiPoIuD;lGnFrDssoli5T;atDpUr68;i,ov4;oz,te4C;d0l0;h3lIo0HrEsDza0Z;er,s;aFeEiDoz5r3Ete4C;!n6F;au,i8no,t4N;!l9;i2Rl0;crac5Ohhail5kke3Qll0;hmeGij0j2FlFndErci0ssiDyer19;!er;e3Bo2Z;n0Io;dBti;cartDlaughl6;hy;dMe6Dgnu5Ei0jer34kLmJnci59rFtEyD;er,r;ei,ic,su1N;iEkBqu9roqu6tinD;ez,s;a54c,nD;!o;a52mD;ad5;e5Oin1;rig4Os1;aSeMiIoGuEyD;!nch;k4nDo;d,gu;mbarDpe2Rvr4;di;!nDu,yana1S;coln,dD;bDholm;erg;bed5TfeGhtFitn0kaEn6rDw2G;oy;!j;in1on1;bvDvD;re;iDmmy,rsCu,voie;ne,t11;aTennedy,h3iSlQnez47oJrGuEvar3woD;k,n;cerDmar58znets5;a,o2G;aDem0i30yeziu;sni3QvD;ch3V;bay4Frh0Jsk0TvaFwalDzl5;czDsA;yk;cFlD;!cDen3R;huk;!ev4ic,s;e6uiveD;rt;eff0l4mu8nnun1;hn,lloe,minsArEstra32to,ur,yDzl5;a,s0;j0GlsC;aMenLha2Qim0RoEuD;ng,r4;e2KhFnErge2Ku2OvD;anB;es,ss2;anEnsD;en,on,t2;nesDsC;en,s1;ki27s1;cGkob3RnsDrv06;en,sD;enDon;!s;ks2obs1;brahimBglesi3Ake4Ll0DnoZoneFshikEto,vanoD;u,v4A;awa;scu;aPeIitchcock,jaltal6oFrist46uD;!aDb0gh9ynh;m3ng;a24dz4fEjga2Tk,rDx3B;ak0Yvat;er,fm3B;iGmingw3NnErD;nand7re8;dDriks1;ers2;kkiEnD;on1;la,n1;dz4g1lvoLmJnsCqIrr0SsFuEyD;as36es;g1ng;anEhiD;mo0Q;i,ov08;ue;alaD;in1;rs1;aNeorgMheorghe,iKjonJoGrEuDw2;o,staf2Utierr7zm3;ayDg4iffitVub0;li1H;lub3Rme0JnEodD;e,m3;calv9zale0H;aj,i;l,mDordaL;en7;iev3A;gnJlGmaFnd2Mo,rDs2Muthi0;cDza;ia;ge;eaElD;agh0i,o;no;e,on;ab0erLiHjeldsted,lor9oFriedm3uD;cDent9ji3E;hs;ntaDrt6st0urni0;na;lipEsD;ch0;ovD;!ic;hatBnandeVrD;arDei8;a,i;ov4;dHinste6riksCsDva0E;cob2ZpDtra2X;inoDosiM;za;en,s2;er,is2wards;aUeMiKjurhuJoHrisco0ZuEvorakD;!oQ;arte,boEmitru,rDt2U;and,ic;is;g3he0Imingu7n2Ord1AtD;to;us;aDmitr29ssanayake;s,z; GbnaFlEmirDrvis1Lvi,w3;!ov4;gado,ic;th;bo0groot,jo04lEsilDvri9;va;a cruz,e2uD;ca;hl,mcevsAnEt2EviD;d5es,s;ieDku1S;ls1;ki;a06e01hOiobNlarkMoFrD;ivDuz;elli;h1lHntGoFrDs26x;byn,reD;a,ia;ke,p0;i,rer0N;em3liD;ns;!e;anu;aLeIiu,oGriDuJwe;stD;eDiaD;ns1;i,ng,uFwDy;!dhury;!n,onEuD;ng;!g;kEnDtterjee,v7;!d,g;ma,raboD;rty;bGl08ng4rD;eghetEnD;a,y;ti;an,ota0L;cer9lder2mpbeIrFstDvadi07;iDro;llo;doEt0uDvalho;so;so,zo;ll;es;a08eWhTiRlNoGrFyD;rne,tyD;qi;ank5iem,ooks,yant;gdan5nFruya,su,uchEyHziD;c,n5;ard;darDik;enD;ko;ov;aEondD;al;nco,zD;ev4;ancRshwD;as;a01oDuiy3;umDwmD;ik;ckNethov1gu,ktLnJrD;gGisFnD;ascoDds1;ni;ha;er,mD;ann;gtDit7nett;ss2;asD;hi;er,ham;b4ch,ez,hMiley,kk0nHrDu0;bEnDua;es,i0;ieDosa;ri;dDik;a8yopadhyD;ay;ra;er;k,ng;ic;cosZdYguilXkhtXlSnJrGsl3yD;aEd6;in;la;aEsl3;an;ujo,ya;dFgelD;ovD;!a;ersGov,reD;aDjL;ss1;en;en,on,s2;on;eksejGiyGmeiFvD;ar7es;ez;da;ev;ar;ams;ta",
      ...
      "Person": "true¦ashton kutchVbUcPdNeLgastQhJinez,jHkGleFmDnettMoCpAr5s4t2va1w0;arrDoode;lentino rossi,n go4;a0heresa may,iger woods,yra banks;tum,ylor;addam hussain,carlett johanssLlobodan milosevic,uD;ay romano,e3o1ush limbau0;gh;d stewart,nald0;inho,o;ese witherspoGilly;a0ipK;lmJris hiltE;prah winfrGra;essia0itt romnFubarek;en;bron james,e;anye west,endall,iefer sutherland,obe bryant;aime,effers8k rowli0;ng;a0itlBulk hogan;lle berry,rris5;ff0meril lagasse,zekiel;ie;a0enzel washingt2ick wolf;lt1nte;ar1lint0;on;dinal wols1son0;! palm2;ey;arack obama,rock;er",
      "Adjective": "true¦0:72;1:6B;2:6D;3:78;4:6W;5:4Y;6:4I;7:41;8:40;9:71;A:5P;B:5D;C:6M;D:6L;E:66;a67b5Sc5Dd4Xe4Lf41g3Uh3Li31ju30k2Yl2Pm2Gn25o1Pp19quack,r0Zs0Ht0CuQvNwFyear5;astBeJholeIiHoF;man5oFu60;d62zy;despr6Ss53;!sa7;eGlFste24;co1Gl o4D;!k5;aGengBiFola43;b7Bce versa;ca3gabo5Rnilla;ltZnLpHrb4XsGtterF;!moD;efAu4; Hb1LpGsFti1E;ca7ide dOtairs;er,i3F;f2Vto da0;aQbecom1convinc1deNeMfair,ivers4knLprecedXrIsGwF;iel38ritt5L;i1SuF;pervis2spect1;eFu5;cognMgul62lF;at2ent1;own;nd1v5Expect2;cid2rF;!grou59sF;iz2tood;b7ppeal1ssum1uthorF;iz2;i1Xra;aHeGhough49ip 1EoFri0;geth6p,rpC;en5Cm4Krr2N;boo,lFn,stB;ent2;aVcUeShRiPmug,nobbi35oNpMqueami35tJuFymb5R;bHi gener4RpFr5;erFre0I;! dup6b,i23;du2seq4F;anda6BeadfaDi0MraightFy2Z; fFfF;or4Z;a4Nec2Cirit2lendCot on; call2le,mb6phistic5ErFu0Wvi3R;dCry;gnifica3nF;ce4Jg7;amBe6ut;cFda0em5lfi2Rni1Spa5Ure8;o1Dr3L;ath1ient24;cr2me;aMeIiGoF;buDtt4JuRy4;ghtFv4;!-w1fA;ar,bZcondi0du5OlHpublic3KsFtard2;is3VoF;lu0na3;e1Buc3T;bCciF;al,st;aPeNicayu8lacCopuliDrFubl50;eJiGoF;!b0Afu56mi2Vp6;mGor,sFva0;ti8;aEe;ci52exist1mF;a0IiF;er,um;acBrFti0;fe9ma2Nv4X;i1UrFst;allHtF;-tiFi4;me;el;bQffOkNld fashion2nMpLrg1Eth6utKvF;al,erF;!aHniGt,wF;eiFrouF;ght;ll;do0Ser,si3W;en,posi0; boa50go1li8;!ay; gua4YbFli8;eat;eHsF;cFer0Fole0;e8u39;d2Ise;aOeNiMoFuanc2;nJrGtF;ab7;thF;!eF;rn;chala3descri4KsF;top;ght5;arby,cessaEighbor5xt;k2usiat1;aKeJinHoFultip7;bi7derFl0Pnth5ot,st;a0n;dblUiaFor;tu2S
fit,oGrEt0Qu1A;ff,n,v7;bo5ft7hMw3;aw3ba4d1in,oGrise,up,w3;ff,n,ut;ar 6ek0t G;aHb19d1in,oGrEup;ff,n,ut,v7;cHhGl22rEt,w3;ead;ross;d aHnG;g 2;bo5;a0Ae03iUlQoMrIuG;cGe27;k 2;eHighten GownAy 2;aw3oB;eGshe1T; 2z8;lIol G;aGwi1M;bo5rE;d 6low 2;aHeGip0;sh0;g 6ke0mGrGttenD;e 2X;gNlLnJrHsGzzle0;h 2V;e Gm 2;aw3ba4up;d0isG;h 2;e Gl 1F;aw3fLin,o5;ht ba4ure0;eLnHsG;s 2;cId G;fGoB;or;e C;dYl 2;cKll Grm0t12;ap07bId1in,oHtG;hrough;ff,ut,v7;a4ehi26;e G;d1oBup;a0Kdge0nd 0Oy8;oJrG;aHess 6op G;aw3bWin,o1T;gAwA; 0Hubl0X;a00hXleaWoJrGut 15;ackAeep Goss C;by,d1in,oGup;n,ut;me JoHuntG; o1V;k 6l G;d1oB;aMbLforJin,oItHuG;nd7;ogeth7;n,ut,v7;th,wG;ard;a4y;pGrEw3;art;n 6;eGipF;ck Cer G;on,up;lMncel0rKsItch HveF; in;o1Dup;h Ct G;doubt,oB;ry Gve 02;aw3o19;l HmD; d1;aGba4d1o16up;rEw3;a0Me0El07oYrLuG;bblIcklZil05lk 6ndlZrGst VtHy 16zz9;n 0AsG;t C;e G;ov7;anReaPiHush G;oBup;ghLng G;aIba4d1fGin,o5up;orG;th;bo5lGrEw3;ong;teG;n 2;k G;d1in,o5up;ch0;arNg 6iLn8oJssIttlHunce Gx C;aw3ba4;e 6; arE;k Ct 2;e 2;l 6;d1up;d 2;aLeed0oGurt0;cIw G;aw3ba4d1o5up;ck;k G;in,oX;ck0nk0st9; oLaJef 2nd G;d1ov7up;er;up;r0t G;d1in,oQup;ff,nG;to;ck Mil0nIrgHsG;h C;ainAe C;g CkA; on;in,o5; o5;aw3d1oGup;ff,ut;ay;cPdLsk Iuction9; oB;ff;arEo5;ouG;nd;d G;d1oGup;ff,n;own;t G;o5up;ut"
    };
    ...
    var switches = {
      "nounVerb": {
        "beforeTags": "Infinitive¦adverb,mod1negative,p0;lur0ronoun;al|Singular¦adject2determiner,gerund,infinit2noun,p0;as0ossess1resen0;ttense;ive",
      ...
      "adjGerund": {
        "beforeTags": "Adjective¦copula,determiner,possessive|Gerund¦adv1conjunc0preposi0v1;tion;erb",
      ...
      "adjPast": {
        "beforeTags": "Adjective¦copula,determiner,possessive|PastTense¦a1n0pron0;oun;dverb,uxiliary",
        "afterTags": "Adjective¦adjective,noun|PastTense¦determiner,p0;ossessive,ronoun",
        "ownTags": "",
        ...
        "words": "true¦0:0S;a0Ob0Mc0AdWeUfSgift0hRiMjLliJmHoFpBre9s4t3u2w1;arp0eath0H;nIpd0Ns0;arnZroubl0;atur0Lca4etXim3peci04t2u1;bsid07spe5;ereotyp0rip0;pl0Eul0I;r0tt0A;cov09f0Agul0Gstri1;ct0;arallel0le0ColRr1u04;e2o1;cUloTnou0E;ferr0oc2par0;c1rganX;cupi0;easEix0o1;d03tV;cens0m1;it0;agg0ust00;mp4n1;br0t1;e1oxic01;gr00rest0;li0oA;ammReYook0;aDix0ra1;ct2gment0;ducVns1quipp0stabl8xperieX;ur0;aDe7i1;gnOmin5s1;ciplLgrun3t1;o1r8;rt0;tl0;ish0;centr5pr4ra3t1velop0;a1ermF;il0;ng0;ess0;al4;mag0t0;elebrFharg0lAo6r4u1;lt2stom1;iz0;ivC;a1owd0;mp0;d0mb3n1;sid1troll0;er0;in0;ass1os0;ifi0;ala5i1;as0;cknowledg0d2nim1ppreci1ssum0;at0;opt0va1;nc0;ed",
        "fallback": "Adjective"
      },
      "personNoun": {
        "beforeTags": "Person¦honorific,p0;ers0repositi0;on|Singular¦adject2determiner,gerund,infinit2noun,p0;as0ossess1resen0;ttense;ive",
        "afterTags": "Person¦p0verb;erson,ropernoun|Singular¦copula,modal,noun,p0value;as0resen0;ttense",
        "ownTags": "Singular¦propernoun",
        "beforeWords": "Person¦dear,h0yo;e0i;llo,y|Singular¦a7cut6for,is,m3o2pl4save1w0;as,ith;!d,s;f,n;a1in0;us;de,ke0;!s;ll,ny",
        "afterWords": "Person¦fe7learn6play5s2t0;el7h0old;inks,ought;a1eems,ing,pend0;s,t;id,ng,ys;ed,s;!ed;e0lt;ls|Singular¦a2method,of,philosophy,r1system,t0util3;herapy,ool;eform,oom;id,uthor0;ity",
        "words": "true¦a0Lb0Dc09d01eZfYgWhRjNkJlImColive,p8r5s3trini0Cv0wang;an,i0;cto0Lol0;a,et;a0ky,on6umm0GydnA;lvador,ntiaZ;ay,e1o0uF;b00d,se;ed,x;a2e0ol;aQn0;ny;ris,tW;a4e2i0;ck0l2;ey;loZrced0;es;x,ya;aEeo,iJ;e2i0obe;ng,r0tR;by;lvKnt;a2e1o0;lUrdan,y;an,w4;de,smi6y;a1iOo0;l9pe,us2;ll,mil1z0;el;ton;ail,e0rant;ne;aith,ern,lo,ranco;a0dFlmo,mir,ula,ve;rl;a4e3i1ol0;ly;ck,e0xF;go;an,ja;i1rw0wn;in;sy;atalina,h0liff,rystal;ari1in,risti0;!an;ty;a4e3i2r0;an0ook;dy;ll;nedict,rg;k1rb0;ie;er;l0rt;exand0fredo,ma;ria",
        "fallback": "Singular"
      },
      "personDate": {
      ...
      "gerundNoun": {
        "beforeTags": "Gerund¦adv1conjunc0preposi0v1;tion;erb|Singular¦adject2determiner,gerund,infinit2noun,p0;as0ossess1resen0;ttense;ive",
    ...
    const titleCase$2 = function (obj) {
      return Object.keys(obj).reduce((h, key) => {
        let name = toTitleCase$1(key).replace(/tense$/, 'Tense');
        h[name] = obj[key];
        return h
      }, {})
    };
    ...
    Object.keys(switches).forEach(k => {
      Object.keys(switches[k]).forEach(key => {
        if (switches[k][key] !== '' && key !== 'fallback') {
          switches[k][key] = O(switches[k][key]);
        }
      });
      switches[k].beforeTags = titleCase$2(switches[k].beforeTags);
      switches[k].afterTags = titleCase$2(switches[k].afterTags);
      switches[k].ownTags = titleCase$2(switches[k].ownTags);
    });
    ...
    var transform = { nounToPlural, nounToSingular, verbToInfinitive, verbConjugate, adjToSuperlative, adjToComparative };
    ...
    const expandLexicon = function (words, model) {
      ...
      const world = { model: { two: model }, methods: methods$1 };
    ...
    var checkLexicon$1 = checkLexicon;
    ...
    const checkCase = function (terms, i, model) {
      ...
      if (i !== 0 && titleCase$1.test(str) === true && hasNumber.test(str) === false) {
    ...
    const lookAtWord$1 = function (term, words) {
      if (!term) {
        return null
      }
      // look at prev word <-
    ...
    const lookAtTag$1 = function (term, tags) {
      if (!term) {
        return null
      }
    ...
    const neighbours = function (terms, i, model) {
      ...
      if (term.tags.size === 0) {
        let tag = null;
        // look left <-
        tag = tag || lookAtWord$1(terms[i - 1], leftWords);
        // look right ->
        tag = tag || lookAtWord$1(terms[i + 1], rightWords);
        // look left <-
        tag = tag || lookAtTag$1(terms[i - 1], leftTags);
        // look right ->
        tag = tag || lookAtTag$1(terms[i + 1], rightTags);
        if (tag) {
    ...
    var switchChange = swtichLexicon;

    const first = {
      multiWord: multiWord$1,
      checkLexicon: checkLexicon$1,
    };
    const second = {
      checkSuffix,
    ...
    var compute$2 = { preTagger: preTagger$1, tagRank: tagRank$1 };
    ...
    //really easy ones
    const contractions$1 = (document = [], world) => {
          ...
          list.some(o => {
            ...
            // bob's
              ...
              if (isPossessive$1(terms, i)) {
                ...
                words = apostropheS$1(terms, i);
              }
            }
            // ain't
            else if (after === 't') {
              words = apostropheT$1(terms, i);
            }
            // how'd
            else if (after === 'd') {
    ...
    */
    ...
    /* demo/contractions/App.svelte generated by Svelte v3.43.0 */
    const file = "demo/contractions/App.svelte";
    ...
    function create_default_slot_1(ctx) {
    	...
    	function codemirror_text_binding(value) {
    		/*codemirror_text_binding*/ ctx[3](value);
    	}

    	let codemirror_props = { highlight: /*onChange*/ ctx[2] };
    	...
    	const block = {
    		c: function create() {
    			div0 = element("div");
    			div0.textContent = "compromise-contractions";
    			t1 = space();
    			kbd = element("kbd");
    			kbd.textContent = "import nlp from 'compromise/two'";
    			t3 = space();
    			div1 = element("div");
    			t4 = space();
    			div2 = element("div");
    			div2.textContent = "split-apart words -";
    			t6 = space();
    			div4 = element("div");
    			...
    			div3 = element("div");
    			t8 = text$1(/*res*/ ctx[1]);
    			attr_dev(div0, "class", "b sea");
    			add_location(div0, file, 31, 4, 827);
    			set_style(kbd, "font-size", "1rem");
    			add_location(kbd, file, 33, 4, 881);
    			set_style(div1, "margin-top", "2rem");
    			add_location(div1, file, 34, 4, 954);
    			attr_dev(div2, "class", "down tab");
    			add_location(div2, file, 35, 4, 991);
    			attr_dev(div3, "class", "res down");
    			add_location(div3, file, 38, 6, 1120);
    			attr_dev(div4, "class", "down");
    			add_location(div4, file, 36, 4, 1043);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (!current || dirty & /*res*/ 2) set_data_dev(t8, /*res*/ ctx[1]);
    		},
    		i: function intro(local) {
    			if (current) return;
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "");
    			add_location(a, file, 45, 2, 1231);
    			attr_dev(div, "class", "right light f09 svelte-10cwet2");
    			add_location(div, file, 44, 0, 1199);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [text, res, onChange, codemirror_text_binding];
    }
